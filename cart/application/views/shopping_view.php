        ...
        <script type="text/javascript">
            ...
            function loadBelow500()
            {
               ...
               /* var xhttp = new XMLHttpRequest();
                ...
                xhttp.open("GET", "<?php echo base_url()?>shopping/view_all_Below_500", true);
                xhttp.send();
                */
                 $.ajax({
                    type:'POST',
                    url: '<?php echo base_url()?>shopping/view_all_Below_500',
                    data:{id:'id'},
...
<?php endif; ?>
        ...
        <table>
            <tr>Filters</tr><br>
            <tr>
                <a style="cursor: pointer;" onclick="loadBelow500();">below 500 /-</a>
